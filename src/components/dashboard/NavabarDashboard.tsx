      ...
      <header className="bg-muted-pink fixed w-full z-10">
        <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-12 items-center">
            ...
            <a href='#aboutMe' className="cursor-pointer text-md font-light text-gray-100 hover:text-pale-peach transition-colors">
              Sobre mim
            </a>
            <a href='#services' className="cursor-pointer text-md font-light text-gray-100 hover:text-pale-peach transition-colors">
              Serviços
            </a>
            <a href='#schedule' className="cursor-pointer text-md font-light text-gray-100 hover:text-pale-peach transition-colors">
              Agendar consulta
            </a>
          </PopoverGroup>
        </nav>
