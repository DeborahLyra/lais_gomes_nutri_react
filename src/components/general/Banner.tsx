    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between h-auto md:h-[550px] bg--light-gray p-6 md:p-10">
            ...
            <div className='flex items-center gap-8'>
                <button className='w-40 text-white bg-primary p-2 rounded-md cursor-pointer'>  
                    Agendar consulta
                </button>
                <button className='w-40 text-primary border-4 border-primary p-2 rounded-md cursor-pointer'>  
                    Saiba mais
                </button>
